  ...
  const subscribeWebPush = async () => {
    ...
    if ("serviceWorker" in navigator && "PushManager" in window) {
      try {
        ...
        const vapidKey = process.env.NEXT_PUBLIC_VAPID_KEY || "YOUR_VAPID_KEY"; // Add your VAPID key here
        ...
        if (user_id) {
          console.log("Sending subscription to backend for user_id:", user_id);
  ...
  return (
    <div className="flex items-center justify-center min-h-screen flex-col">
      ...
      <div className="flex items-center mt-20 bg-gray-100 px-4 py-2 rounded-md w-full max-w-xs justify-between">
        ...
        <Switch checked={isNotificationEnabled} onChange={handleSwitchChange} />
      </div>
      {permissionMessage && (
